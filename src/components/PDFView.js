...
function PDFView({ size }) {
	...
	return (
		<div className="relative">
			...
			<div className="absolute z-50 top-4 left-4 p-2 bg-white shadow-lg text-brand rounded-xl">
				<svg
			...
			<div className="absolute bottom-4 left-1/4 z-50 flex items-center space-x-2 text-brand bg-white shadow-lg px-4 py-2 rounded-full">
				<svg
